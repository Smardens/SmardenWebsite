...
[caption id="attachment_235" align="aligncenter" width="1024"]<img class="wp-image-235 size-large" src="https://caitlinr1.sgedu.site/wp-content/uploads/2018/05/Architecture-Overview-1024x428.png" alt="Architecture Overview" width="1024" height="428" /> This architecture overview diagram shows the user of the system will be the normal user and the maintenance expert. The system will be using sensors, Arduino board, solar panels, Wi-Fi module and automatic watering function. The system will use crop nutrient database as support system.[/caption]
